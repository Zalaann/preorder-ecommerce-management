...
import { Package, Plane, Users, Home, CreditCard, Menu, X, LogOut, Moon, Sun, Bell } from 'lucide-react';
...
export default function EmployeeDashboardLayout({
  ...
  const navItems = [
    { href: '/employee', icon: <Home className="w-5 h-5" />, label: 'Dashboard' },
    { href: '/employee/pre-orders', icon: <Package className="w-5 h-5" />, label: 'Pre-Orders' },
    { href: '/employee/flights', icon: <Plane className="w-5 h-5" />, label: 'Flights' },
    { href: '/employee/customers', icon: <Users className="w-5 h-5" />, label: 'Customers' },
    { href: '/employee/payments', icon: <CreditCard className="w-5 h-5" />, label: 'Payments' },
    { href: '/employee/reminders', icon: <Bell className="w-5 h-5" />, label: 'Reminders' },
  ];
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <header className="md:hidden sticky top-0 z-40 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="flex items-center justify-between px-4 py-3">
          <h1 className="text-xl font-bold gradient-text">Employee Panel</h1>
