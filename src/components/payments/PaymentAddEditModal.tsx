...
const PaymentAddEditModal: React.FC<PaymentAddEditModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen) {
      if (isEditing && payment) {
        ...
        setFormData({
          payment_id: '', // This will be generated by Supabase
          customer_id: '',
          preorder_id: '',
          amount: 0,
          payment_purpose: 'advance',
  ...
  const handlePreOrderChange = async (preOrderId: string) => {
    ...
    try {
      ...
      if (data) {
        ...
        // Suggest the remaining amount as the payment amount
      ...
      console.error('Error in handlePreOrderChange:', error);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // We don't need to generate a payment ID anymore as it's handled by Supabase
      // The payment_id field will be empty for new payments and will be generated by the database
      ...
      if (isEditing) {
        ...
        console.log('Creating payment with data:', submissionData);
        result = await createPayment(submissionData as Payment);
      }
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-[700px] max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700 p-0">
                      ...
                      {selectedPreOrder && !preOrderSearchOpen && (
                        <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md">
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                              <span className="font-semibold text-gray-700 dark:text-gray-300">Total Amount:</span> ${((selectedPreOrder.subtotal || 0) + (selectedPreOrder.cod_amount || 0)).toFixed(2)}
                            </div>
